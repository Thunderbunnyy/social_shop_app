...
class FlipLoader extends StatefulWidget {
  ...
  FlipLoader({this.loaderBackground = Palette.coral, this.iconColor = Palette.lavender, this.icon = Icons.sync, this.animationType = "full_flip", this.shape = "square", this.rotateIcon = true});
