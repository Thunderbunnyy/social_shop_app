...
import 'package:social_shop_app/data/repositories/Users/provider_db_user.dart';
...
class UserRepository implements UserProviderContract {
  ...
  // @override
  // Future<ApiResponse> loginWithFacebook(User user) => api.loginWithFacebook(user);


  // @override
  // Future<ApiResponse> loginWithGoogle(User user) => api.loginWithGoogle(user);
